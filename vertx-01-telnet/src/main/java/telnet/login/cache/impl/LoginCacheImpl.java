package telnet.login.cache.impl;

import telnet.login.cache.LoginCache;
import telnet.login.cache.bean.LoginCacheBean;
import telnet.login.util.SerializationUtil;
